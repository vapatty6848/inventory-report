...
class SimpleReport:
    ...
    def oldest_product(all_product_list):
        ...
        for each_product in all_product_list:
            ...
            if index == 0 and oldest_product > today_parse:
                ...
                print(oldest_product > today_parse)
    ...
    def generate(data):
        message = (
            ...
            f"{SimpleReport.get_oldest_manufacture(data)}\n"
            f"Data de validade mais próxima: "
            f"{SimpleReport.oldest_product(data)}\n"
            f"Empresa com maior quantidade de produtos estocados: "
            f"{SimpleReport.get_company_name(data)}\n"
        )
        return message
...
message = SimpleReport.generate(path)
print(message)
